...
export default class TileMap {
    ...
    map = [
        ...
        [1, 6, 0, 7, 0, 0, 2, 1, 0, 1, 0, 1],
        [1, 0, 1, 1, 2, 5, 5, 1, 0, 1, 0, 1],
        [2, 0, 8, 3, 1, 5, 5, 2, 7, 0, 8, 2],
        [1, 7, 1, 2, 2, 1, 2, 1, 0, 1, 7, 1],
        [1, 0, 0, 6, 0, 7, 0, 0, 6, 2, 0, 1],
        [1, 0, 2, 1, 1, 2, 1, 8, 1, 1, 0, 1],
        [1, 6, 0, 0, 1, 3, 6, 0, 0, 0, 6, 1],
        [1, 0, 2, 1, 2, 1, 0, 1, 2, 1, 0, 1],
        [1, 8, 6, 0, 7, 0, 0, 8, 0, 6, 3, 1],
        [1, 2, 1, 1, 1, 2, 1, 1, 1, 1, 2, 1]
    ];
    ...
    map2 = [
        [1, 2, 1, 1, 1, 2, 1, 1, 1, 1, 2, 1],
        [1, 4, 0, 0, 8, 0, 7, 0, 6, 0, 7, 1],
        [1, 0, 1, 2, 7, 1, 2, 1, 2, 1, 0, 1],
        [1, 0, 1, 7, 6, 0, 0, 0, 8, 1, 0, 1],
        [1, 7, 0, 2, 1, 0, 2, 0, 2, 0, 6, 1],
        [2, 0, 1, 8, 0, 0, 1, 7, 3, 0, 1, 2],
        [1, 0, 0, 7, 0, 1, 2, 0, 1, 2, 7, 1],
        [1, 7, 1, 2, 6, 0, 0, 6, 0, 0, 6, 1],
        [1, 6, 1, 7, 0, 0, 2, 1, 0, 1, 0, 1],
        [1, 0, 1, 1, 2, 5, 5, 5, 1, 7, 0, 1],
        [2, 1, 2, 3, 1, 5, 5, 5, 2, 0, 1, 2],
        [1, 7, 1, 6, 2, 1, 2, 1, 0, 0, 7, 1],
        [1, 0, 0, 8, 0, 7, 0, 0, 6, 2, 0, 1],
        [1, 0, 6, 2, 1, 2, 1, 8, 1, 1, 0, 1],
        [1, 1, 0, 0, 1, 3, 6, 0, 0, 0, 6, 1],
